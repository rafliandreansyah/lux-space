                  ...
                  <div className="flex flex-col mb-4">
                    ...
                    <div className="flex -mx-2 flex-wrap">
                      <div className="px-2 w-6/12 h-24 mb-4">
                        ...
                        >
                          <img
                            src="/src/assets/images/content/logo-fedex.svg"
                            alt="Logo Fedex"
                      ...
                      <div className="px-2 w-6/12 h-24 mb-4">
                        ...
                        >
                          <img
                            src="/src/assets/images/content/logo-dhl.svg"
                            alt="Logo dhl"
                            className="object-contain max-h-full"
                          />
                        </button>
                  ...
                  <div className="flex flex-col mb-4">
                    ...
                    <div className="flex -mx-2 flex-wrap">
                      <div className="px-2 w-6/12 h-24 mb-4">
                        ...
                        >
                          <img
                            src="/src/assets/images/content/logo-midtrans.png"
                            alt="Logo midtrans"
                            className="object-contain max-h-full"
                          />
                        </button>
                      ...
                      <div className="px-2 w-6/12 h-24 mb-4">
                        ...
                        >
                          <img
                            src="/src/assets/images/content/logo-mastercard.svg"
                            alt="Logo mastercard"
                          />
                        </button>
                      </div>
                      <div className="px-2 w-6/12 h-24 mb-4">
                        ...
                        >
                          <img
                            src="/src/assets/images/content/logo-bitcoin.svg"
                            alt="Logo bitcoin"
                            className="object-contain max-h-full"
                          />
                        </button>
                      ...
                      <div className="px-2 w-6/12 h-24 mb-4">
                        ...
                        >
                          <img
                            src="/src/assets/images/content/logo-american-express.svg"
