    ...
    <header className="absolute w-full z-50">
      <div className="container mx-auto px-4 py-5">
        <div className="flex flex-row">
          ...
          <div className="grow">
            <ul className="flex flex-row justify-end items-center invisible md:text-white md:visible">
              <li className="mx-5">
                <a href="#">Showcase</a>
              </li>
              <li className="mx-5">
          ...
          <div className="absolute visible md:invisible right-2">
            <ul className="flex flex-row justify-center items-center">
              ...
              <li className="mx-2 md:mx-0">
                <a
                  id="header-cart"
                  className="flex items-center justify-center w-8 h-8 md:w-0 md:h-0 text-black"
                  href="cart.html"
                >
                  <svg
                    className="fill-current"
